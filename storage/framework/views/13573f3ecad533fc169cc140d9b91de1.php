...
<body class="bg-gray-50">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
                            <div class="p-6">
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-3">
                                    <div class="bg-blue-600 h-3 rounded-full transition-all duration-300" style="width: <?php echo e($completionPercentage); ?>%"></div>
                                </div>
                        ...
                        <?php $__currentLoopData = $challenge->tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-100 <?php echo e(!$canAccess ? 'opacity-50' : ''); ?>">
                                <div class="p-6">
                                    ...
                                    <!-- Hints Section -->
                                    <?php if($canAccess && $task->hints->count() > 0): ?>
                                                        ...
                                                        <div class="p-4">
                                                            <div class="flex items-start justify-between">
                                                                ...
                                                                <div class="ml-4 flex flex-col items-end">
                                                                    <?php if(!in_array($hint->id, $userHints)): ?>
                                                                        <button onclick="purchaseHint(<?php echo e($hint->id); ?>, <?php echo e($hint->cost); ?>)" 
    ...
    <script>
        ...
        function purchaseHint(hintId, cost) {
            const userPoints = <?php echo e(auth()->user()->points ?? 0); ?>;
...
<?php /**PATH C:\laragon\www\cyber-infinity\resources\views/challenges/show.blade.php ENDPATH**/ ?>