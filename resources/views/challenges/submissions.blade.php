...
<head>
    ...
    <title>Submissions: {{ $challenge->title }} - Cyber Infinity</title>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="flex items-center space-x-2 mb-2">
                                <a href="{{ route('challenges.show', $challenge) }}" class="text-gray-400 hover:text-gray-600">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full 
                                        @if($challenge->difficulty === 'Easy') bg-green-100 text-green-800
                                        @elseif($challenge->difficulty === 'Medium') bg-yellow-100 text-yellow-800
                                        @elseif($challenge->difficulty === 'Hard') bg-red-100 text-red-800
                                        @else bg-gray-100 text-gray-800
                                        @endif">
                                        {{ $challenge->difficulty }}
                                    </span>
                                </div>
                                <h2 class="text-lg font-semibold text-gray-800">{{ $challenge->title }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $submission->task->title ?? 'Deleted Task' }}</div>
                            <div class="text-sm text-gray-500">Order: {{ $submission->task->order ?? '-' }}</div>
                        </td>
                        <td class="px-6 py-4">
    ...
    <div class="mt-6 bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            @foreach($challenge->tasks()->where('is_active', true)->orderBy('order')->get() as $task)
                @php
                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div>
                        ...
                        <div class="text-xs text-gray-500">Task {{ $task->order }} • {{ $task->points }} pts</div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm font-semibold text-gray-900">{{ $taskSolvers }}</div>
