...
<body class="bg-white">
                ...
                <nav class="flex-1 px-4 py-4 space-y-2">
                    ...
                    <div x-data="{ open: true }" class="relative">
                        ...
                        <div x-show="open" x-transition class="mt-1 ml-6 space-y-1">
                            ...
                            <?php if(auth()->user()->isAdmin()): ?>
                            <a href="<?php echo e(route('admin.ctf.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-blue-600 bg-blue-100 rounded-lg">
                                <i class="fas fa-cog w-4 h-4 mr-3"></i>
                                Kelola CTF
                            </a>
                            <?php endif; ?>
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <a href="<?php echo e(route('admin.ctf.create')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900"><?php echo e($ctfs->count()); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900"><?php echo e($ctfs->where('status', 'active')->filter(function($ctf) { return $ctf->start_time <= now() && $ctf->end_time >= now(); })->count()); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900"><?php echo e($ctfs->where('status', 'active')->filter(function($ctf) { return $ctf->start_time > now(); })->count()); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900"><?php echo e($ctfs->filter(function($ctf) { return $ctf->end_time < now(); })->count()); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__currentLoopData = $ctfs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ctf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="hover:bg-gray-50">
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <?php if($ctf->banner_image): ?>
                                                            <img class="h-10 w-10 rounded-lg object-cover" src="<?php echo e(Storage::url($ctf->banner_image)); ?>" alt="<?php echo e($ctf->name); ?>">
                                                        <?php else: ?>
                                                        ...
                                                        <?php endif; ?>
                                                        <div class="ml-4">
                                                            <div class="text-sm font-medium text-gray-900"><?php echo e($ctf->name); ?></div>
                                                            <div class="text-sm text-gray-500"><?php echo e(Str::limit($ctf->description, 50)); ?></div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm text-gray-900">
                                                        <div><?php echo e($ctf->start_time->format('d M Y H:i')); ?></div>
                                                        <div class="text-gray-500"><?php echo e($ctf->end_time->format('d M Y H:i')); ?></div>
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <?php if($ctf->status == 'draft'): ?>
                                                        <span class="px-2 py-1 text-xs font-semibold rounded-full bg-gray-100 text-gray-800">
                                                            <i class="fas fa-edit mr-1"></i>Draft
                                                        </span>
                                                    <?php elseif($ctf->isActive()): ?>
                                                    ...
                                                    <?php elseif($ctf->status == 'active' && !$ctf->hasStarted()): ?>
                                                        <span class="px-2 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800">
                                                            <i class="fas fa-clock mr-1"></i>Upcoming (<?php echo e($ctf->start_time->diffForHumans()); ?>)
                                                        </span>
                                                    <?php elseif($ctf->status == 'inactive'): ?>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    <div class="flex items-center">
                                                        ...
                                                        <?php echo e($ctf->challenges_count ?? 0); ?> soal
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    <div class="flex items-center">
                                                        <i class="fas fa-users text-gray-400 mr-2"></i>
                                                        <?php echo e($ctf->getTotalParticipants()); ?> peserta
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                                    <div class="flex items-center space-x-2">
                                                        <a href="<?php echo e(route('admin.ctf.challenges', $ctf)); ?>" 
                                                        ...
                                                        <a href="<?php echo e(route('admin.ctf.submissions', $ctf)); ?>" 
                                                        ...
                                                        <a href="<?php echo e(route('admin.ctf.edit', $ctf)); ?>" 
                                                        ...
                                                        <button onclick="confirmDelete(<?php echo e($ctf->id); ?>, '<?php echo e($ctf->name); ?>')" 
                        ...
                        <?php else: ?>
                            ...
                            <div class="p-12 text-center">
                                ...
                                <a href="<?php echo e(route('admin.ctf.create')); ?>" 
    ...
    <?php $__currentLoopData = $ctfs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ctf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form id="delete-form-<?php echo e($ctf->id); ?>" action="<?php echo e(route('admin.ctf.destroy', $ctf)); ?>" method="POST" style="display: none;">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\cyber-infinity\resources\views/admin/ctf/index.blade.php ENDPATH**/ ?>