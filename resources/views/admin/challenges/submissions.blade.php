...
<head>
    ...
    <title>Submissions Challenge: {{ $challenge->title }} - Cyber Infinity</title>
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex items-center space-x-2">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $challenge->getCategoryColor() }}">
                                        {{ $challenge->category }}
                                    </span>
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $challenge->getDifficultyColor() }}">
