...
<head>
    ...
    <title>Leaderboard - {{ $ctf->name }} | Cyber Infinity</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <a href="{{ route('ctf.show', $ctf) }}" class="mr-4 text-gray-600 hover:text-gray-900 transition-colors">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">
                            @if(count($chartData) > 0)
                                Top {{ count($chartData) }} players' points over time for this CTF
                            @else
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    <div class="p-6 flex items-center justify-between hover:bg-gray-50 cursor-pointer transition-colors duration-200 rank-item"
                         onclick="window.location.href='/ctf/{{ $ctf->id }}/user/{{ $user->id }}'">
                            <div class="flex items-center space-x-4">
                                <!-- Rank Badge -->
                            ...
                            <div class="flex items-center space-x-8 text-right">
                                <div>
                                <p class="text-2xl font-bold text-blue-600">{{ number_format($user->total_points) }}</p>
                                    <p class="text-sm text-gray-500">Points</p>
                                </div>
                                <div>
                                <p class="text-lg font-semibold text-green-600">{{ number_format($user->solved_challenges) }}</p>
