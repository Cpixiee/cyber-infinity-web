...
<head>
    ...
    <script>
        ...
        window.usernameSetupRoute = "<?php echo e(route('profile.setup-username')); ?>";
        
        // Set chart data for JavaScript
        window.chartData = {
            registration: {
                labels: <?php echo json_encode($dailyLabels ?? ['Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab', 'Min']); ?>,
                values: <?php echo json_encode($dailyValues ?? [2, 5, 3, 8, 4, 6, 7]); ?>

            },
            performance: <?php echo e($performancePercentage ?? 75); ?>

        };
        
        <?php if(auth()->user()->needsUsernameSetup()): ?>
    ...
    <!-- External CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/responsive-layout.css')); ?>">
    
    <!-- External JavaScript -->
    <script src="<?php echo e(asset('js/mobile-navigation.js')); ?>"></script>
    <script src="<?php echo e(asset('js/dashboard-charts.js')); ?>"></script>
    <script src="<?php echo e(asset('js/username-setup.js')); ?>"></script>
...
<body class="bg-white">
        ...
        <aside id="sidebar" class="w-64 bg-white shadow-sm border-r border-gray-200 fixed inset-y-0 left-0 z-50 transform -translate-x-full transition-transform duration-300 lg:!transform-none lg:!translate-x-0 lg:!static lg:!inset-0">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-4 space-y-2">
                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-lg">
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Selamat datang kembali, <?php echo e(auth()->user()->name); ?></p>
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="text-right">
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($userGrowth >= 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                    <i class="fas <?php echo e($userGrowth >= 0 ? 'fa-arrow-up' : 'fa-arrow-down'); ?> mr-1"></i>
                                    <?php echo e(number_format(abs($userGrowth), 1)); ?>%
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900"><?php echo e($totalWorkshops); ?></p>
                                </div>
                            </div>
                            <div class="text-right">
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($workshopsActive > 0 ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'); ?>">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900"><?php echo e($currentActiveUsers); ?></p>
                                </div>
                            </div>
                            <div class="text-right">
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($activeUserGrowth >= 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                    <i class="fas <?php echo e($activeUserGrowth >= 0 ? 'fa-arrow-up' : 'fa-arrow-down'); ?> mr-1"></i>
                                    <?php echo e(number_format(abs($activeUserGrowth), 0)); ?>%
                                </span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="relative w-48 h-48">
                                ...
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <div class="text-center">
                                        <div class="text-3xl font-bold text-gray-900"><?php echo e(number_format($performancePercentage, 0)); ?>%</div>
                                        <div class="text-sm <?php echo e($performanceGrowth >= 0 ? 'text-green-600' : 'text-red-600'); ?>"><?php echo e($performanceGrowth >= 0 ? '+' : ''); ?><?php echo e(number_format($performanceGrowth, 0)); ?>%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="text-sm text-gray-600 text-center">
                            Performance berdasarkan login & workshop. <?php echo e($currentActiveUsers); ?> user aktif dari <?php echo e($totalUsers); ?> total user. 
                            <?php if($performancePercentage >= 80): ?>
                                Excellent performance!
                            <?php elseif($performancePercentage >= 60): ?> 
                                Good performance!
                            <?php elseif($performancePercentage >= 40): ?>
                                Average performance
                            <?php else: ?>
                                Needs improvement
                            <?php endif; ?>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <?php $__empty_1 = true; $__currentLoopData = $recentWorkshops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workshop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                        <div class="p-2 bg-blue-100 rounded-lg">
                                            <i class="fas fa-graduation-cap text-blue-600"></i>
                                        </div>
                                        <div class="ml-3 flex-1">
                                            <p class="text-sm font-medium text-gray-900"><?php echo e($workshop->title); ?></p>
                                            <p class="text-xs text-gray-500"><?php echo e($workshop->created_at->diffForHumans()); ?></p>
                                        </div>
                                        <span class="px-2 py-1 text-xs rounded-full <?php echo e($workshop->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                        ...
                                        <div class="ml-3 flex-1">
                                            <p class="text-sm font-medium text-gray-900"><?php echo e($registration->full_name); ?></p>
                                            <p class="text-xs text-gray-500"><?php echo e($registration->workshop->title ?? 'Workshop tidak ditemukan'); ?></p>
                                        </div>
    ...
    <script>
        ...
        function initializeCharts() {
            ...
            // Debug data
            console.log('Monthly data:', <?php echo json_encode($monthlyUserRegistrations, 15, 512) ?>);
            console.log('Performance percentage:', <?php echo e($performancePercentage); ?>);
            ...
            const monthlyUserData = <?php echo json_encode($monthlyUserRegistrations, 15, 512) ?>;
            ...
            let performancePercentage = <?php echo e($performancePercentage); ?>;
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="swal-name" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" 
                                       placeholder="Masukkan nama lengkap" value="<?php echo e(auth()->user()->name); ?>" />
                            </div>
                            <div>
        ...
        function submitUsernameSetup(name, username) {
            ...
            // Send data to server
            fetch('<?php echo e(route("profile.setup-username")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
...
<?php /**PATH C:\laragon\www\cyber-infinity-web\resources\views/dashboard.blade.php ENDPATH**/ ?>