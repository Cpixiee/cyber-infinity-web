...
<head>
    ...
    <title>Submissions: <?php echo e($challenge->title); ?> - Cyber Infinity</title>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="flex items-center space-x-2 mb-2">
                                <a href="<?php echo e(route('challenges.show', $challenge)); ?>" class="text-gray-400 hover:text-gray-600">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex items-center space-x-2">
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full 
                                        <?php if($challenge->category === 'Web'): ?> bg-blue-100 text-blue-800
                                        <?php elseif($challenge->category === 'Crypto'): ?> bg-purple-100 text-purple-800
                                        <?php elseif($challenge->category === 'Forensic'): ?> bg-green-100 text-green-800
                                        <?php elseif($challenge->category === 'OSINT'): ?> bg-yellow-100 text-yellow-800
                                        <?php elseif($challenge->category === 'Reverse'): ?> bg-red-100 text-red-800
                                        <?php elseif($challenge->category === 'Pwn'): ?> bg-gray-100 text-gray-800
                                    ...
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full 
                                        <?php if($challenge->difficulty === 'Easy'): ?> bg-green-100 text-green-800
                                        <?php elseif($challenge->difficulty === 'Medium'): ?> bg-yellow-100 text-yellow-800
                                        <?php elseif($challenge->difficulty === 'Hard'): ?> bg-red-100 text-red-800
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-500 uppercase tracking-wide">Total Tasks</p>
                    <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e($stats['total_tasks']); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-6">
            ...
            <p class="text-green-100 text-sm mt-2">Daftar semua submissions yang masuk untuk challenge ini</p>
        </div>
    ...
    <div class="mt-6 bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <?php $__currentLoopData = $challenge->tasks()->where('is_active', true)->orderBy('order')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $taskSolvers = $submissions->where('task.id', $task->id)->count();
                ?>
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div>
                        <div class="text-sm font-medium text-gray-900"><?php echo e($task->title); ?></div>
                        <div class="text-xs text-gray-500">Task <?php echo e($task->order); ?> • <?php echo e($task->points); ?> pts</div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm font-semibold text-gray-900"><?php echo e($taskSolvers); ?></div>
                        <div class="text-xs text-gray-500">solvers</div>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\cyber-infinity\resources\views/challenges/submissions.blade.php ENDPATH**/ ?>