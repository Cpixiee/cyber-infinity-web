...
<head>
    ...
    <title>Kelola Soal CTF - {{ $ctf->name }} - Cyber Infinity</title>
...
<body class="bg-white">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <div class="flex items-center mb-2">
                                <a href="{{ route('admin.ctf.index') }}" class="mr-3 text-gray-600 hover:text-gray-900">
                                    <i class="fas fa-arrow-left"></i>
                                </a>
                                <h1 class="text-2xl font-bold text-gray-900">Kelola Soal CTF</h1>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="text-sm text-gray-600">{{ $ctf->name }}</span>
                                @if($ctf->isActive())
                        ...
                        <div class="flex items-center space-x-4">
                            <a href="{{ route('admin.ctf.challenges.create', $ctf) }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200">
                ...
                <div class="max-w-7xl mx-auto">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900">{{ $challenges->count() }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900">{{ $challenges->where('status', 'active')->count() }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900">{{ $challenges->where('status', 'draft')->count() }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900">{{ $challenges->where('status', 'active')->sum('points') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-200">
                            <h2 class="text-lg font-semibold text-gray-900">Semua Soal CTF</h2>
                        </div>
                                ...
                                <table class="w-full">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Solves</th>
                                        ...
                                        @foreach($challenges as $challenge)
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                                    <span class="px-2 py-1 text-xs font-medium rounded-full {{ $challenge->getPointsColor() }}">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                                    <div class="flex items-center justify-center space-x-2">
                                                        <a href="{{ route('admin.ctf.challenges.edit', [$ctf, $challenge]) }}" 
                                                        ...
                                                        <button onclick="confirmDelete({{ $challenge->id }}, '{{ $challenge->title }}')" 
                        ...
                        @else
                            ...
                            <div class="p-12 text-center">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-4">Belum Ada Soal CTF</h3>
                                <p class="text-gray-600 mb-8">Mulai buat soal CTF pertama untuk event ini</p>
                                <a href="{{ route('admin.ctf.challenges.create', $ctf) }}" 
    ...
    @foreach($challenges as $challenge)
        <form id="delete-form-{{ $challenge->id }}" action="{{ route('admin.ctf.challenges.destroy', [$ctf, $challenge]) }}" method="POST" style="display: none;">
            @csrf
            @method('DELETE')
        </form>
    @endforeach
    ...
    <script>
        ...
        function confirmDelete(challengeId, challengeTitle) {
            Swal.fire({
                title: 'Hapus Soal CTF?',
                html: `Apakah Anda yakin ingin menghapus soal <strong>"${challengeTitle}"</strong>?<br><br><small class="text-red-600">⚠️ Semua submission untuk soal ini akan ikut terhapus!</small>`,
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#ef4444',
                cancelButtonColor: '#6b7280',
