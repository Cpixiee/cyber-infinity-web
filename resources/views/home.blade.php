...
@section('title', 'Home - Cyber Infinity')
...
<div class="hero-section">
    <div class="video-background">
        <video autoplay muted loop playsinline>
            <source src="{{ asset('images/cyber-bg.mp4') }}" type="video/mp4">
        </video>
    ...
    <div class="hero-content">
        ...
        <div class="buttons-container">
            <a href="{{ route('register') }}" class="cyber-button">Read more</a>
            <a href="{{ route('login') }}" class="cyber-button secondary">Get started</a>
        </div>
    </div>
</div>
