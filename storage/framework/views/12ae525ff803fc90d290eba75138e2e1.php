            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-4 space-y-2">
                    ...
                    <div x-data="{ open: true }" class="relative">
                        ...
                        <div x-show="open" x-transition class="mt-1 ml-6 space-y-1">
                            <a href="<?php echo e(route('ctf.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-blue-600 bg-blue-100 rounded-lg">
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <?php if($activeCtfs->count() > 0): ?>
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <?php $__currentLoopData = $activeCtfs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ctf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bg-white rounded-xl border border-green-200 shadow-sm overflow-hidden hover:shadow-md transition-all duration-300 transform hover:scale-105">
                                        <?php if($ctf->banner_image): ?>
                                            <div class="h-48 bg-cover bg-center" style="background-image: url('<?php echo e(Storage::url($ctf->banner_image)); ?>')"></div>
                                        <?php else: ?>
                                        ...
                                        <div class="p-6">
                                            <div class="flex items-center justify-between mb-3">
                                                <h3 class="text-lg font-bold text-gray-900"><?php echo e($ctf->name); ?></h3>
                                                <span class="px-2 py-1 bg-green-100 text-green-800 text-xs font-bold rounded-full animate-pulse">
                                                    LIVE
                                                </span>
                                            </div>
                                            
                                            <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e($ctf->description); ?></p>
                                            
                                            <div class="space-y-2 mb-4">
                                                <div class="flex items-center text-sm text-gray-500">
                                                    <i class="fas fa-clock mr-2"></i>
                                                    <span>Berakhir: <?php echo e($ctf->end_time->format('d M Y H:i')); ?></span>
                                                </div>
                                                <div class="flex items-center text-sm text-gray-500">
                                                    <i class="fas fa-users mr-2"></i>
                                                    <span><?php echo e($ctf->getTotalParticipants()); ?> peserta</span>
                                                </div>
                                                <?php if($ctf->challenges_count > 0): ?>
                                                    <div class="flex items-center text-sm text-gray-500">
                                                        <i class="fas fa-puzzle-piece mr-2"></i>
                                                        <span><?php echo e($ctf->challenges_count); ?> soal</span>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                    ...
                    <?php if($upcomingCtfs->count() > 0): ?>
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <?php $__currentLoopData = $upcomingCtfs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ctf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="p-6">
                                            ...
                                            <div class="space-y-2 mb-4">
                                                <div class="flex items-center text-sm text-gray-500">
                                                    ...
                                                    <span>Mulai: <?php echo e($ctf->start_time->format('d M Y H:i')); ?></span>
                                                </div>
                                                <div class="flex items-center text-sm text-gray-500">
                                                    <i class="fas fa-stop-circle mr-2"></i>
                                                    <span>Berakhir: <?php echo e($ctf->end_time->format('d M Y H:i')); ?></span>
                                                </div>
                                                <?php if($ctf->max_participants): ?>
                                                    <div class="flex items-center text-sm text-gray-500">
                                                        <i class="fas fa-user-friends mr-2"></i>
                                                        <span>Maks: <?php echo e($ctf->max_participants); ?> peserta</span>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="bg-gray-100 text-gray-700 font-medium py-3 px-4 rounded-lg text-center">
                                                <i class="fas fa-clock mr-2"></i>
                                                <?php echo e($ctf->getTimeRemaining()); ?>
                    ...
                    <?php if($endedCtfs->count() > 0): ?>
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <?php $__currentLoopData = $endedCtfs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ctf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-all duration-300 opacity-75">
                                        <?php if($ctf->banner_image): ?>
                                            <div class="h-48 bg-cover bg-center grayscale" style="background-image: url('<?php echo e(Storage::url($ctf->banner_image)); ?>')"></div>
                                        <?php else: ?>
                                        ...
                                        <div class="p-6">
                                            ...
                                            <div class="space-y-2 mb-4">
                                                <div class="flex items-center text-sm text-gray-500">
                                                    ...
                                                    <span>Selesai: <?php echo e($ctf->end_time->format('d M Y H:i')); ?></span>
                                                </div>
                                                <div class="flex items-center text-sm text-gray-500">
                                                    <i class="fas fa-users mr-2"></i>
                                                    <span><?php echo e($ctf->getTotalParticipants()); ?> peserta</span>
                    ...
                    <!-- No CTFs Available -->
                    <?php if($activeCtfs->count() == 0 && $upcomingCtfs->count() == 0 && $endedCtfs->count() == 0): ?>
...
</html><?php /**PATH C:\laragon\www\cyber-infinity\resources\views/ctf/index.blade.php ENDPATH**/ ?>