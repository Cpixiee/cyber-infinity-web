        ...
        <aside id="sidebar" class="w-64 bg-white shadow-sm border-r border-gray-200 fixed inset-y-0 left-0 z-50 transform -translate-x-full transition-transform duration-300 lg:!transform-none lg:!translate-x-0 lg:!static lg:!inset-0">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-4 space-y-2">
                    ...
                    <a href="<?php echo e(route('admin.registrations.index')); ?>" class="flex items-center px-3 py-2 text-sm font-medium text-blue-600 bg-blue-50 rounded-lg">
        ...
        <div class="flex-1 lg:ml-0">
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <button onclick="window.location.href='<?php echo e(route('workshops.index')); ?>'" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200">
            ...
            <main class="flex-1 p-6 bg-white">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                    <div x-data="{ activeTab: <?php echo e($workshops->first()->id ?? 0); ?> }">
                        <!-- Tabs -->
                        <div class="border-b border-gray-200">
                            <nav class="-mb-px flex overflow-x-auto" aria-label="Tabs">
                                ...
                                <button @click="activeTab = <?php echo e($workshop->id); ?>" 
                                    :class="{ 
                                        'border-blue-500 text-blue-600': activeTab === <?php echo e($workshop->id); ?>,
                                        'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': activeTab !== <?php echo e($workshop->id); ?>

                                    }"
                                    class="whitespace-nowrap py-4 px-6 border-b-2 font-medium text-sm transition-colors duration-200"
                                    <?php if($index === 0): ?> x-init="activeTab = <?php echo e($workshop->id); ?>" <?php endif; ?>>
                                    <?php echo e($workshop->title); ?>

                                    <span class="ml-2 px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-600">
                                        <?php echo e($workshop->registrations->count()); ?>
                        ...
                        <div x-show="activeTab === <?php echo e($workshop->id); ?>" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <?php $__empty_1 = true; $__currentLoopData = $workshop->registrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($registration->class); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($registration->nis); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($registration->email); ?></td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                ...
                                                <div class="flex justify-end space-x-2">
                                                    <form action="<?php echo e(route('admin.registrations.approve', $registration)); ?>" method="POST" class="inline">
                                                        <?php echo csrf_field(); ?>
                                                    ...
                                                    <form action="<?php echo e(route('admin.registrations.reject', $registration)); ?>" method="POST" class="inline">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('PATCH'); ?>
...
</html><?php /**PATH C:\laragon\www\cyber-infinity-web\resources\views/admin/registrations/index.blade.php ENDPATH**/ ?>